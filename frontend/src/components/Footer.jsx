...
const Footer = () => {
  return (
    <div>
      <footer className="px-6 md:px-16 lg:px-24 xl:px-32 w-full text-white">
        <div className="flex flex-col md:flex-row items-start justify-center gap-10 py-10 border-b border-gray-500/30">
          <div className="max-w-96">
            <p className="text--700">STUDYLOOM</p>
            <p className="mt-6 text-sm text-gray-500">
              StudyLoom is a modern web application designed to simplify online
              learning and teaching by providing a seamless platform for selling
              and purchasing courses. The project allows educators to easily
              upload course.🚀
            </p>
        ...
        <p className="py-4 text-center text-xs md:text-sm text-gray-500">
          Copyright 2025 © <a href="">StudyLoom</a>. All
          Right Reserved.
        </p>
      </footer>
    </div>
