...
function Dashboard() {
  ...
  return (
    <div className="flex h-screen bg-gradient-to-r from-black to-blue-900">
      {/* Sidebar */}
      <div className="w-64 bg-gradient-to-r from-black to-blue-900 bg-gray-100 p-5">
        <div className="flex items-center flex-col mb-10">
          <img src={logo} alt="Profile" className="rounded-full h-20 w-20" />
          <h2 className="text-lg font-semibold mt-4 text-white">I'm Owner</h2>
        </div>
